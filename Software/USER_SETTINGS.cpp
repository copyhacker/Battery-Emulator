...
std::string ssid = "AAA WIFI";          // Maximum of 63 characters
std::string password = "AAAUtility2018";  // Minimum of 8 characters
const char* ssidAP = "Lilygo";  // Maximum of 63 characters, also used for device name on web interface
